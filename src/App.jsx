...
const DEFAULT_SETTINGS = { goalKcal: 1500, goalWeight: 60, startWeight: 85.15, intolerances: ["lactose", "sucre"], macroProtein: 120, macroCarbs: 150, macroFat: 50 };
const TABS = [
...
const HISTORY_WEIGHTS = [
  { date: "2026-03-23", weight: 85.15 },
];

const STORAGE_PREFIX = "nt4_comp_";
